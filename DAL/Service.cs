    ...
    public class Service
    {
        ...
        public static void AnyadirGenero(Genero nuevoGenero)
        {
            ...
            try
            {
                ...
                {
                    miComando.Parameters.Add("@nombre", System.Data.SqlDbType.VarChar).Value = nuevoGenero.Nombre;
                    miComando.Parameters.Add("@descripcion", System.Data.SqlDbType.VarChar).Value = nuevoGenero.Descripcion;

                    miComando.CommandText = "INSERT INTO GenerosDeLibros (Nombre, Descripcion) VALUES (@nombre, @descripcion)";
        ...
        public static void ModificarGenero(Genero generoActualizado)
        {
            ...
            try
            {
                ...
                if (conexion.State == System.Data.ConnectionState.Open)
                {
                    miComando.Parameters.Add("@id", System.Data.SqlDbType.Int).Value = generoActualizado.Id;
                    miComando.Parameters.Add("@nombre", System.Data.SqlDbType.VarChar).Value = generoActualizado.Nombre;
                    miComando.Parameters.Add("@descripcion", System.Data.SqlDbType.VarChar).Value = generoActualizado.Descripcion;

                    miComando.CommandText = "UPDATE GenerosDeLibros SET Nombre = @nombre, Descripcion = @descripcion WHERE Id = @id";
                    miComando.Connection = conexion;
        ...
        public static void EliminarGenero(int id)
        {
            ...
            try
            {
                ...
                if (conexion.State == System.Data.ConnectionState.Open)
                {
                    ...
                    miComando.CommandText = "DELETE FROM GenerosDeLibros WHERE Id = @id";
                    miComando.Connection = conexion;
